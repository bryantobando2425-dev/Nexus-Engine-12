...
NEXUS ENGINE is a full-stack procedural narrative game engine PWA. It uses AI narration (Google Gemini via Replit integration) to tell the story of any life, in any era, with no objectives — pure open-ended existence simulation.

**Current game: "A Life"** — Live any life, in any era, on Earth.

**Version: v5.4 (State Rewrite + Custom Sections)** — Current corrections add full-state AI snapshots, manual correction improvements, and scoped custom sections:
...
- **AI**: Google Gemini via Replit AI Integration (no API key required — billed to Replit credits)
